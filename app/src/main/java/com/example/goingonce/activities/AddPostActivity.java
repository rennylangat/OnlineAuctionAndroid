...
public class AddPostActivity extends AppCompatActivity {
    ...
    private EditText itmName,itmDesc,itmBaseBid,itemLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef= FirebaseDatabase.getInstance().getReference().child("Posts").child(uID);
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                publishPost(itemName,type,itemDesc,baseBid,location);
            }
        });
    }
    ...
    private void publishPost(String itemName,String type,String itemDesc,String baseBid,String location) {
